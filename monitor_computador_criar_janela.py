...
from tkinter import simpledialog, messagebox, Toplevel, Label, Text, Scrollbar, Button, Frame, StringVar, OptionMenu
...
def executar_validacao():
    ...
    # Baseado na seleção, definir o caminho do Excel
    tipo_selecionado = resultado["tipo"]
    if tipo_selecionado == "Computador":
        caminho_excel = 'C:/Users/p0134255/Desktop/Validação/Computador/Planilha_Definitiva___Onda_5.xlsx'
    else:  # Monitor
        caminho_excel = 'C:/Users/p0134255/Desktop/Validação/Monitor/Planilha_Definitiva___Onda_5.xlsx'
    
    # Solicita o número ao usuário
    numero = simpledialog.askstring("Entrada", f"Digite o número do arquivo {tipo_selecionado}:")
    ...
    caminho_pdf = f'C:/Users/p0134255/Desktop/Validação/{tipo_selecionado}/{numero}.pdf'
    ...
    resumo += f"Arquivo PDF: {numero}.pdf\n\n"
    ...
    caminho_saida = f"C:/Users/p0134255/Desktop/Validação/{tipo_selecionado}/validacao_{numero}.xlsx"
